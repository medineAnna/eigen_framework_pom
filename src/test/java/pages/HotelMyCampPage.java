...
public class HotelMyCampPage {
    ...
    public WebElement basariliGirisOnayText;

    @FindBy(xpath = "//button[@data-bb-handler='ok']")
    public WebElement basariliGirisOnayTextOkButtonu;

    @FindBy(xpath = "//span[.=Lisst Of Hotelrooms']")
    public WebElement hotelRoomsListOnayYazi;
